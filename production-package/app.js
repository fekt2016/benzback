...
========================= */
// MEMORY OPTIMIZATION: Reduced payload limits to prevent large in-memory allocations
// 1mb is sufficient for most API requests, prevents memory spikes from large payloads
app.use(express.json({ limit: "1mb" })); // Reduced from 10mb to 1mb for memory efficiency
app.use(express.urlencoded({ extended: true, limit: "1mb" })); // Reduced from 10mb to 1mb
