...
exports.updateDriverStatus = catchAsync(async (req, res, next) => {
  ...
  // Map status values: Driver model uses "active" for available, DriverProfile uses "available"
  // For unified Driver model, we'll use: "pending", "active", "suspended"
  // For DriverProfile compatibility: "available", "busy", "offline"
